  ...
  return (
    <header className="sticky top-0 z-30 flex h-topbar shrink-0 items-center justify-between border-b border-gray-200 bg-white px-24 dark:border-border-dark dark:bg-primary">
      <div className="flex items-center gap-16">
        ...
        {/* Recontiq logo (inline SVG) - increased size */}
        <a href="/" aria-label="Recontiq home" className="flex items-center gap-3">
          <svg className="w-9 h-9" viewBox="0 0 30 28" fill="none" aria-hidden>
            <path d="M10 4L4 14L10 24" stroke="#4ade80" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M20 4L26 14L20 24" stroke="rgba(0,0,0,0.25)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx="15" cy="14" r="2" fill="#4ade80" />
          </svg>
          {/* hide text on small screens to keep the topbar compact */}
          <span className="hidden sm:inline-block text-lg font-medium text-primary dark:text-primary-light">Recontiq</span>
        </a>
      </div>
